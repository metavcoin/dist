...
import { ismetavcoinAsset } from '../../utils/metavcoinUtils'
import { metavcoinP_MAX_DECIMALS, metavcoinP_MIN_DECIMALS } from '../../constants'
          ...
          <Flexbox flexDirection="column" className="form-container">
            ...
            <Flexbox flexDirection="row">
              ...
              <AmountInput
                ...
                maxDecimal={ismetavcoinAsset(asset) ? metavcoinP_MAX_DECIMALS : 0}
                minDecimal={ismetavcoinAsset(asset) ? metavcoinP_MIN_DECIMALS : 0}
