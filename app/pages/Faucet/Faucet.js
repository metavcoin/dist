      ...
      <Layout className="faucet">
        <Flexbox flexDirection="column" className="faucet-container">
          ...
          <Flexbox flexDirection="column" className="page-title">
            <h1>Get Access to the metavcoin Software</h1>
            <h3>
              To gain access to the metavcoin software insert the key generated
              {' '}using our software sale wallet and redeem your tokens.
              <br />
              If you didn&apos;t save your key contact our support team at <a href="mailto:info@metavcoin.com">info@metavcoin.com</a> and we&apos;ll help you retrieve it
              <br />
              You can also retrieve it by visiting&nbsp;
              <ExternalLink
                link="https://crowdsale.metavcoin.com/create-wallet/complete"
              >this link
            ...
            <Flexbox>
              <h3 className="agree-to-terms">
                * By claiming your tokens you agree to the&nbsp;
                <ExternalLink
                  link="https://www.metavcoin.com/legal/metavcoin_x_token_sale_agreement.pdf"
