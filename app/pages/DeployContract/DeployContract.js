...
class DeployContract extends Component<Props> {
  ...
  get isAmountValid() {
    ...
    return deployContractStore.blocksAmount &&
      calcMaxBlocksForContract(portfolioStore.metavcoinBalance, deployContractStore.code.length)
    ...
    return (
      <FormResponseMessage className="error">
        <span>
          ...
          developer and direct them to use the metavcoin-SDK to test the contract.
          <br />
          SDK Link:{' '}
          <ExternalLink link="https://github.com/metavcoin/ZFS-SDK">
            https://github.com/metavcoin/ZFS-SDK
          </ExternalLink>
        </span>
      </FormResponseMessage>
    )
          ...
          <Flexbox flexDirection="column" className="form-container">
            ...
            <Flexbox flexDirection="row" className="contract-name-and-amount form-row">
              ...
              <AmountInput
                ...
                maxAmount={calcMaxBlocksForContract(portfolioStore.metavcoinBalance, code.length)}
