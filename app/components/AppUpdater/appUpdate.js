...
export const RELEASE_API_URL = 'https://api.github.com/repos/metavcoin/metavcoinwallet/releases/latest'
export const LATEST_RELEASE_URL = 'https://github.com/metavcoin/metavcoinwallet/releases/latest'
