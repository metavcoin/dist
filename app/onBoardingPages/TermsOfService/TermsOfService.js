    ...
    return (
      <OnBoardingLayout className="terms-of-service-container" progressStep={5}>
        ...
        <div className="terms-of-service-content">
          <h1> metavcoin Authorized x </h1>
          <h2> Preamble </h2>
          <p>
            This document defines the metavcoin authorized x (the “​Authorized x​”), including conditions that ​users must meet
            in order to use the Licensed Software pursuant to the ​Software License​. For the avoidance of doubt, nothing other than
            the Software License grants you permission to use, propagate or modify the Licensed Software, and the Authorized x
            ...
            You are not required to accept the Authorized x; however, failure to accept and act in accordance with the
            Authorized x terminates your right to use the Licensed Software. Use of the Licensed Software in contravention of
            either the Authorized x or the Software License is considered a breach of the Software License and copyright
            infringement.
          </p>
          <p>
            You may not modify the Authorized x or the Licensed Software except as expressly provided under the Authorized x.
            Any attempt otherwise to modify the Authorized x or the Licensed Software is considered a breach of the Software License,
            automatically terminates your right to use the Licensed Software and is copyright infringement.
          </p>
          <p>
            By using the Licensed Software, you indicate your acceptance of the Authorized x and Software License.
          </p>
          <p>
            All service providers or developers who produce tools to facilitate the construction and signing of smart contracts or
            transactions on behalf of other metavcoin Token holders must present this Authorized x document and other referenced
          ...
          <p>
            This software is in the copyright of metavcoin LTD (Owned by Blockchain Development LTD). While the company is not waiving its
          ...
          <ol type="I" className="list-of-terms">
            ...
            <h2> <span className="bold">AUTHORIZED x</span> </h2>
            <ul>
              <li>
                <span >Section 1.01 Authorized x​.</span> The Authorized x is the set of rules and processes by which blocks
                ...
                The Authorized x includes the version of the Licensed Software that accepts those blocks and transactions that the
                Community Release accepts and rejects those blocks and transactions which the Community Release rejects.
              </li>
              <li>
                <span >Section 1.02 Community Release​.</span> The Community Release is ​the later of (i) the first x client compiled
                from the code with git commit/tag identifier [37ce6b3f626137b09147849b146716fbf5ad4872] released on June 30, 2018
                (also known as “​EZRA​”), and (ii) any subsequent version of code that is approved by Community Vote.
              ...
              <li>
                <span >Section 1.04 Initial Circulating Supply; Increase in Supply​.</span> The Initial Circulating Supply of metavcoin Tokens
                (i.e., those metavcoin Tokens that have been issued on the Community Release Blockchain) is 20% of the total number of metavcoin Tokens to be issued.
                Generally, additional metavcoin Tokens shall be generated according to the following approximate sexennial schedule:
                <ol type="a">
                  <li> Over the six years following the Community Release Date, 40% of the total number of metavcoin Tokens to be issued shall be issued; </li>
                  <li> Over the following six years, an additional 20% of the total number of metavcoin Tokens to be issued shall be issued; </li>
                  <li> Over the third sexennial period, an additional 10% of the total number of metavcoin Tokens to be issued shall be issued; </li>
            ...
            <ol>
              <li>
                ...
                the rules are made by the community of metavcoin Token holders. To this end, Article II provides rules for decentralized governance
              ...
              <li>
                <span >Section 2.02 Changes to the Authorized x​.</span> At any time, an affirmative majority vote (50% plus one metavcoin Token)
                of the total number of metavcoin Tokens that have been issued on the Community Release Blockchain (such issued total, the “​Existing Tokens​”)
                can authorize a change to the Authorized x. Each metavcoin Token entitles the owner to one vote. For the avoidance of doubt,
                metavcoin Tokens that have not yet been generated are not included in calculating the total of Existing Tokens. In addition, a change to
                the Authorized x is not necessarily a change to the underlying Licensed Software. Prior to being voted on for adoption,
                any proposed change to the Authorized x must first be determined to be eligible for such a vote in the first place.
                ...
                The following is a non-exhaustive list of items that require a majority vote (50% plus one metavcoin Token) of Existing Tokens:
                <ol type="i">
                  ...
                  <li> a change of maximum 100 million total supply of metavcoin Tokens to be generated (Section 1.04); </li>
                  <li> a change of metavcoin Token supply curve (Section 1.04);</li>
                  <li> a change of the genesis block necessary for the authorized x; or</li>
                  <li> a change to the voting threshold requirements.</li>
                </ol>
              </li>
              <ol type="a">
                <li>
                  <span>Changes to Community Release​.</span> If a majority (50% of Tokens voted plus one metavcoin Token) of votes cast (but not necessarily a majority
                  ...
                  in the Community Vote); provided, however, that such new Community Release does not contravene the Authorized x. A change to the Community
                  Release that contravenes the Authorized x is considered a breach of the Software License, automatically terminates your right to
                  ...
                  Community Release that would require a change to the Authorized x (i.e. because such new Community Release contravenes the Authorized x
                  in place at the time), the voting requirements in Section 2.02 must first be followed to authorize the necessary change to the Authorized x.
                  That is, in advance of the scheduled semiannual Community Vote, the user can initiate an unscheduled vote on a proposal to change the Authorized x
                  pursuant to Section 2.02. Prior to being voted on for adoption, any proposed changes to the Authorized x must first be determined to
                ...
                <li>
                  ...
                  If a majority (50% of Tokens voted plus one metavcoin Token) of votes cast in the runoff support a new Community Release proposal, such version shall be
                ...
                <li>
                  ...
                  <ol type="i">
                    ...
                    <li>
                      ...
                      Therefore the Authorised x at the end of 1 year should contain roughly 64,800 blocks of SHA-256 preceded by 64,800 blocks of
                      SHA-3 that terminate/originate with genesis block X;
                    </li>
                    <li>
                      implement a stop every 7 months blocks. EZRA (version one of the Community Release) has a stop after 7 months. Version two is
                      elected by the community, but must include a hard stop 7 months later, unless a majority of 50% plus one metavcoin Token of Existing
                ...
                <li>
                  ...
                  in order for a proposed Community Release version and/or potential upgrade to the Authorized x to be eligible for a Community Vote,
                  ...
                  signed with a public key associated with a metavcoin balance to Authorized Nodes by initiating a transaction to the voting smart contract.
                  The transaction message shall include a smart contract with metavcoin Tokens information clearly indicating the proposal that you wish to be
              ...
              <li>
                ...
                proposal to be voted on by sending a message signed with a public key associated with a metavcoin balance to Authorized Nodes by initiating a transaction to
                ...
                with a metavcoin balance to Authorized Nodes by initiating a transaction to the voting smart contract. The transaction message shall include a smart contract with
                ...
                <ol type="a">
                  ...
                  <li>
                    ...
                    <ol type="i">
                      <li>
                        Votes shall occur every six months, beginning with six months from the EZRA release date.
                      </li>
                ...
                <li>
                  <span >Section 2.05 Adherence to Additional Principles​. </span> Proposed upgrades to the Community Release and/or Authorized x must preserve:
                  <ol type="i">
                    <li>
                    ...
                    <li>
                      the ability of Token holders to vote on future proposed upgrades to the Authorized x and Community Release; and
                    </li>
                ...
                <li>
                  ...
                  “Hard Forks” are not an acceptable consensus mechanism. Each community member has the right to keep his or her metavcoin Tokens whole and not
                  split, which may diminish the value of the metavcoin Tokens.
                </li>
                <li>
                  <span >Section 2.07 Initial Reserved Powers.</span> Notwithstanding the other provisions of this Authorized x, Blockchain Development LTD
                  ...
                  reliable operation of the metavcoin blockchain. Such updates may be made in addition to any passed via the other mechanisms permitted
                  by this Authorized x.
                </li>
              </li>
            </ol>
          </ol>
          <h2> END OF AUTHORIZED x </h2>
          ...
          <div>
            <h2><span className="bold" >metavcoin​ ​x​ ​SOFTWARE​ ​LICENSE</span></h2>
            <p>
              This metavcoin Software License (this <span className="bold">"Agreement"​</span>) governs Your use of the
              computer software (including wallet, miner, tools, compilers, documentation, examples, source
              code and other files) as may be made available by <span className="bold">metavcoin Ltd​</span>, a Seychelles company
              <span className="bold">(“Licensor”​)</span> via GitHub at https://github.com/metavcoin/metavcoin-wallet or from any other
            ...
            <ol type="I" className="list-of-terms">
              ...
              <li className="definitions" >
                ...
                <ol type="a">
                  ...
                  <li>
                    <span className="bold">“Authorized x​”</span> means the rules, data structures, programming
                    language, scripts, cryptographic signing methods, and communication xs solely as
                    ...
                    Release Date, the Authorized x shall mean such version of the Authorized
                    x in effect on the Community Release Date, or as applicable any amendment
                    thereafter made by the required consensus of Authorized Nodes (determined in
                    accordance with the Authorized x in effect immediately prior to such amendment).
                  </li>
                  <li>
                    ...
                    encrypted signatures in accordance with the Authorized x, which blocks are
                    formed, confirmed by consensus, and extended solely by Authorized Nodes running the
                    Licensed Software in accordance with the Authorized x.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    signatures in accordance with the Authorized x, which data packet is included in
                    the applicable Blockchain and transferable via the applicable Blockchain in accordance
                    with the Authorized x. A “Token” is “contained” in a Wallet if such Token is
                    registered on the Blockchain to a public key or keys contained in such Wallet determined
                    in accordance with the Authorized x.
                  </li>
                  <li>
              ...
              <li className="initial-term">
                ...
                <ol type="a">
                  <li>
                    ...
                    the Licensed Software in accordance with the Authorized x. Licensor shall
              ...
              <li className="community-release">
                ...
                <ol type="a">
                  ...
                  <li>
                    ...
                    of the Authorized x published by Licensor and in effect as of the Community
                    Release Date, or as applicable (ii) the then current amended version of the Authorized
                    x if such Authorized x has been amended by the required consensus of
                    Authorized Nodes (determined in accordance with the Authorized x in effect
                  ...
                  <li>
                    ...
                    that fully complies with the then current Authorized x, or (ii) developing a test
                    version of Licensed Software for testing Use in connection with a good faith proposal by
                    You or another person to modify the Authorized x; provided in each case,
                  ...
                  <li>
                    ...
                    comply with the then current Authorized x or that You are testing to confirm
                    compliance with such Authorized x) that You or any other person develops in
