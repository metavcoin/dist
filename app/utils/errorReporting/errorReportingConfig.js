...
export const endpoint = 'https://metavcoin-x.sp.backtrace.io:6098'
export const token = 'df7048b99dfc5cb58f6a99939aa40ef2fac9d7c8af43be487fa479bb63015b52'
export const attributes = {
  NODE_ENV: process.env.NODE_ENV,
  walletVersion: pjson.version,
  metavcoinNodeVersion: pjson.dependencies['@metavcoin/metavcoin-node'],
...
export const crashReporterOpts = {
  productName: 'metavcoin',
  companyName: 'metavcoinwallet',
